...
public class InterfaceGraphique {
  ...
  public InterfaceGraphique(Forme forme){
    this.forme=forme;
    fenetre(); // Configure la fenêtre
    afficherZones(); // Appelle l'affichage des zones dès l'instanciation
  ...
  private void dessinerGrille(int rows, int cols, double centerX, double centerY, double halfWidth, double halfHeight, double maxHalfLength){
  ...
  /*private boolean isCaseSelected(int row, int col){
    ...
    return (mouseX<=caseDroite && mouseX>=caseGauche && mouseY<=caseHaut && mouseY>=caseBas);
  }*/
